...
import com.example.spring.data.payload.request.LoginRequest;
import com.example.spring.data.payload.request.SignupRequest;
import com.example.spring.data.payload.response.JwtResponse;
import com.example.spring.data.payload.response.MessageResponse;
import com.example.spring.data.repository.MemberRepo;
import com.example.spring.data.repository.RoleRepo;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        if (memberRepo.existsByMemberName(signUpRequest.getUsername())) {
